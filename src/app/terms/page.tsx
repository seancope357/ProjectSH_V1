    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-md p-8 prose prose-gray max-w-none">
          ...
          <p>
            SequenceHUB is a platform that allows users to share, discover, and purchase automation sequences, 
            macros, and workflows. The service includes but is not limited to:
          </p>
          <ul>
          ...
          <p>
            You are solely responsible for the content you upload, post, or share on SequenceHUB. You agree not to:
          </p>
          <ul>
          ...
          <p>
            By uploading content to SequenceHUB, you grant us a non-exclusive, worldwide, royalty-free license 
            to use, display, and distribute your content on the platform. You retain ownership of your content 
          ...
          <p>
            ...
            that such content does not infringe on the rights of any third party.
          </p>

          <h2>6. Seller Terms</h2>
          <p>
            If you choose to sell sequences on SequenceHUB, additional terms apply:
          </p>
          <ul>
            <li>You must complete seller verification before listing paid content</li>
            <li>SequenceHUB charges a 15% platform fee on all sales</li>
            <li>Payments are processed weekly with a minimum threshold of $25</li>
            <li>You are responsible for the quality and functionality of your sequences</li>
            <li>Refunds may be issued at our discretion for defective or misrepresented content</li>
          </ul>
          ...
          <p>
            You use sequences at your own risk. Always test sequences in a safe environment before 
            implementing them in production systems.
          </p>

          <h2>9. Limitation of Liability</h2>
          <p>
            In no event shall SequenceHUB, its officers, directors, employees, or agents be liable for any 
          ...
          <p>
            Email: legal@sequencehub.com<br />
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-8">
            ...
            <p className="text-blue-700 text-sm">
              By continuing to use SequenceHUB, you acknowledge that you have read, understood, 
