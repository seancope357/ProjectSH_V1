      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Our community thrives on collaboration, creativity, and respect. These guidelines help ensure 
                a positive experience for everyone sharing and discovering automation sequences.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-3">❌ What Not to Share</h3>
              <ul className="space-y-2 text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-3">Sequence Requirements</h3>
              <ul className="space-y-2 text-gray-600">
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-3">Documentation Standards</h3>
              <ul className="space-y-2 text-gray-600">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p className="text-yellow-700 text-sm">First-time or minor violations</p>
              </div>
              
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                <h3 className="font-medium text-orange-800 mb-2">Suspension</h3>
                <p className="text-orange-700 text-sm">Repeated or serious violations</p>
              </div>
              
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <h3 className="font-medium text-red-800 mb-2">Ban</h3>
                <p className="text-red-700 text-sm">Severe or persistent violations</p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
              ...
              <p className="text-blue-700 text-sm">
                ...
                please report it to our moderation team through the contact page.
              </p>
            </div>
          </div>
        </div>
