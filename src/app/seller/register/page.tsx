      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="mt-2 text-gray-600">
            Join our marketplace and start selling your sequences
          </p>
        </div>
      </div>
              ...
              return (
                <div key={step.number} className="flex items-center">
                  ...
                  {index < steps.length - 1 && (
                    <div
                      className={`flex-1 h-0.5 mx-4 ${isCompleted ? 'bg-green-500' : 'bg-gray-300'}`}
                    />
                  )}
                </div>
              )
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-700 text-sm mt-1">
                        We need your tax information to comply with tax
                        reporting requirements. This information is kept secure
                        and confidential.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-green-700 text-sm mt-1">
                        Your banking information is encrypted and processed
